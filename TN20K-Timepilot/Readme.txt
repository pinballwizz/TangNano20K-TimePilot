Time Pilot Arcade for the Tang Nano 20K FPGA Dev Board. Pinballwiz.org 2025
Code by DarFPGA.
...
Build:
* Obtain correct roms file for Time Pilot (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make time pilot proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the TN20K-TimePilot project file using GoWin.
